  ...
  struct PosePlugin : ModelPlugin
  {
    ...
    void Load(physics::ModelPtr parent, sdf::ElementPtr sdf)
    {
      ...
      conn_ = event::Events::ConnectWorldUpdateBegin(
          std::bind(&PosePlugin::on_update, this));

      // Start ROS thread
      ros_th_ = std::thread(&PosePlugin::ros_thread, this);
    }
